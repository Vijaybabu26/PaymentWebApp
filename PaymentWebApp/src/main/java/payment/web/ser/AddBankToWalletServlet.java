...
public class AddBankToWalletServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
    public AddBankToWalletServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(db.VerifyAccountNo(DestAccNo)!= null){
		
				db.DoBWTransaction(SrcPhno, TxnAmount, DestAccNo);
